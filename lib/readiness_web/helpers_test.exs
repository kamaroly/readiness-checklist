defmodule ReadinessWeb.HelpersTest do
  use ExUnit.Case, async: true

  alias ReadinessWeb.Helpers
  ...
  describe "is_super_user?/1" do
    setup do
      ...
      original_super_users = Application.get_env(:Readiness, :super_users, [])
      Application.put_env(:Readiness, :super_users, ["super@example.com"])

      on_exit(fn ->
        Application.put_env(:Readiness, :super_users, original_super_users)
      end)
    end
