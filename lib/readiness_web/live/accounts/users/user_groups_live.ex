defmodule ReadinessWeb.Accounts.Users.UserGroupsLive do
  ...
  defp get_user(%{current_user: current_user, user_id: user_id}) do
    Ash.get!(Readiness.Accounts.User, user_id,
      authorize?: false,
      load: :groups,
  ...
  defp get_groups(current_user) do
    {:ok, groups} = Ash.read(Readiness.Accounts.Group, tenant: current_user.current_team)
    groups
  end
