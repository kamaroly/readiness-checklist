defmodule ReadinessWeb.Accounts.Groups.GroupPermissionsLive do
  ...
  defp assign_group_permissions(socket) do
    ...
    group_permissions =
      Readiness.Accounts.GroupPermission
  ...
  defp get_resources(socket) do
    ...
    for domain <- Application.get_env(:Readiness, :ash_domains) do
