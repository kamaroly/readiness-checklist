defmodule ReadinessWeb.Reports.GraphsLive do
        ...
        <div class="card border border-primary">
          <div class="card-body">
            ...
            <div class="overflow-x-auto">
              <ReadinessWeb.Chart.chart type="bar" />
            </div>
          </div>
        </div>
    ...
    <!-- Report 2: Weekly Sales -->
        <div class="card border border-primary">
          <div class="card-body">
            ...
            <div class="overflow-x-auto">
              <ReadinessWeb.Chart.chart type="line" />
            </div>
          </div>
        </div>
    ...
    <!-- Report 3: Top 10 Merchants -->
        <div class="card border border-primary">
          <div class="card-body">
            ...
            <div class="overflow-x-auto">
              <ReadinessWeb.Chart.chart type="radar" />
            </div>
          </div>
        </div>
    ...
    <!-- Report 4: Monthly Sales -->
        <div class="card border border-primary">
          <div class="card-body">
            ...
            <div class="overflow-x-auto">
              <ReadinessWeb.Chart.chart type="doughnut" />
            </div>
          </div>
        </div>
    ...
    <!-- Report 9: Distribution Efficiency -->
        <div class="card border border-primary">
          <div class="card-body">
            ...
            <div class="overflow-x-auto">
              <ReadinessWeb.Chart.chart type="bubble" />
            </div>
          </div>
        </div>
