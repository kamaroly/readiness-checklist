defmodule ReadinessWeb.AshForm do
  @moduledoc """
  ...
  `Readiness.Members.Member` resource, such as `name`, `email`, etc., based on the resource’s
  ...
  - ReadinessWeb.CoreComponents (for input and button components)
  ...
  def render(assigns) do
    ...
    <div class="m-4">
      <Phoenix.Component.form for={@form} phx-change="validate" phx-submit="save" phx-target={@myself}>
        ...
        <div>
          <ReadinessWeb.CoreComponents.input
        ...
        <ReadinessWeb.CoreComponents.button>
          Submit
        </ReadinessWeb.CoreComponents.button>
