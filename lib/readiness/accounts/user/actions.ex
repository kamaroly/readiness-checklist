defmodule Readiness.Accounts.User.Actions do
  ...
  actions do
    ...
    update :switch_team_to do
      ...
      validate Readiness.Accounts.User.Validations.ValidateBelongsToTeam
      change set_attribute(:current_team, arg(:team))
    end
    ...
    create :invite do
      ...
      validate Readiness.Accounts.User.Validations.ValidateNewToTeam
      manual Readiness.Accounts.User.Actions.CreateUserIfNotExists
      change Readiness.Accounts.User.Changes.AddToTeam
    end
    ...
    action :force_sign_in, :map do
      ...
      run Readiness.Accounts.User.Actions.ForceSignIn
    end
  end
