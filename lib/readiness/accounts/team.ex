defmodule Readiness.Accounts.Team do
  ...
  actions do
    ...
    create :create do
      primary? true
      change Readiness.Accounts.Team.Changes.AddUserTeam
      change Readiness.Accounts.Team.Changes.AddTeamOwner
      change Readiness.Accounts.Team.Changes.SwitchActorTeam
    end
  ...
  relationships do
    belongs_to :owner, Readiness.Accounts.User do
